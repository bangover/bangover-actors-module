...
/**
 * This class represents the message object, wrapping data transferring between
 * actors.
 *
...
public final class Message<B> {
	 ...
	 * @return The created message
	 */
	public static final <B> Message<B> createFor(ActorAddress sender, ActorAddress destination, B messageBody) {
	 ...
	 * @param matchedReceiver  The message handle function receiver for case when
	 *                         the message body is matched to specified typee
	 * @throws Throwable The thrown error
	 */
	public <T> void whenIsMatchedTo(Class<T> expectedBodyType, MessageHandleFunction<T> matchedReceiver)
			throws Throwable {
	 ...
	 * @param expectedBodyType  The expected body type class
	 * @param matchedReceiver   The message handle function receiver for case when
	 *                          the message body is matched to specified type
	 * @param unmatchedReceiver The message handle function receiver for case when
	 *                          the message body is unmatched to specified type
	 * @throws Throwable The thrown error
	 */
	public <T> void whenIsMatchedTo(Class<T> expectedBodyType, MessageHandleFunction<T> matchedReceiver,
			MessageHandleFunction<B> unmatchedReceiver) throws Throwable {
	 ...
	 * @param matchedReceiver The message handle function receiver for case when the
	 *                        message body is matched by the specified predicate
	 * @throws Throwable The thrown error
	 */
	public void whenIsMatchedTo(Predicate<B> predicate, MessageHandleFunction<B> matchedReceiver) throws Throwable {
	 ...
	 * @param predicate         The predicate
	 * @param matchedReceiver   The message handle function receiver for case when
	 *                          the message body is matched by the specified
	 *                          predicate
	 * @param unmatchedReceiver The message handle function receiver for case when
	 *                          the message body is unmatched by the specified
	 *                          predicate
	 * @throws Throwable The thrown error
	 */
	...
	/**
	 * This interface declares the contract of the message handling on matched
	 * condition.
	 *
	 * @author Dmitry Mikhaylenko
	 *
	...
	public interface MessageHandleFunction<B> {
		 ...
		 */
		public void receive(B body) throws Throwable;
	}
}
